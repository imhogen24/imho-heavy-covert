...
export const CookieBanner: React.FC = () => {
  const { showBanner, handleAcceptAll, handleRejectAll, toggleSettings } =
    useCookieConsent();
      ...
      <Card className="max-w-4xl mx-auto border-primary/20">
        ...
        <CardContent>
          <p className="text-sm text-muted-foreground">
            We use necessary cookies that are required for the operation of our
            website. You can choose to accept all cookies or customize your
            preferences.
          </p>
        </CardContent>
        <CardFooter className="flex flex-col space-y-2 sm:flex-row sm:space-y-0 sm:space-x-2 justify-end">
          ...
          <Button
            ...
            className="w-full md:w-fit p-3 text-white"
          >
            Accept All
          </Button>
        </CardFooter>

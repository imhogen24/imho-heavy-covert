...
>(({ className, ...props }, ref) => (
  ...
  >
    <CircleCheckBig
      className=" absolute left-1.5 h-4 w-4 transition-opacity data-[state=checked]:opacity-0 data-[state=unchecked]:opacity-100"
      aria-hidden="true"
    />
    <CircleX
      className="absolute right-1.5 h-4 w-4 transition-opacity data-[state=checked]:opacity-100 data-[state=unchecked]:opacity-0"
      aria-hidden="true"
    />

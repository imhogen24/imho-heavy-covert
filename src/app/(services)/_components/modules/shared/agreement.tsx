  ...
  const termsContent = [
    {
      ...
      content:
        "A client refers to an individual representing an organization or their personal business, seeking to successfully onboard a project with IMHO.",
    },
    {
      title: "Use of Client Information",
      content:
        "Clients providing their personal or organizational details to IMHO should do so with the understanding that IMHO strictly uses this information for project onboarding and related documentation. IMHO does not sell, misuse, or collect additional sensitive information for unauthorized purposes.",
    },
    {
      title: "Confidentiality of Shared Information",
      content:
        "All project-related information or specifications submitted to IMHO during onboarding are treated as confidential and will not be disclosed publicly without the explicit consent of the client.",
    },
    {
      title: "Intellectual Property Considerations",
      content:
        "Any information shared with IMHO is not automatically considered copyrighted, patented, or proprietary unless a prior agreement stating otherwise is in place. Clients should take appropriate legal steps to protect sensitive intellectual property before disclosure.",
    },
    {
      title: "Compliance with IMHO's Standard Operating Procedures",
      content:
        "Clients agree to adhere to IMHO's standard operating procedures (SOPs) for project onboarding and execution. These procedures ensure efficiency and clarity in service delivery. Details of the SOPs can be found be downloaded on page.",
    },
    {
      title: "Service Charges and Value Proposition",
      content:
        "IMHO's product and process development services are structured to provide comprehensive solutions, including Engineering Design, Procurement, Fabrication, Construction, Delivery, and/or Commissioning. Clients understand that service charges reflect the full value of these phases and are billed accordingly.",
    },
    {
      title: "Distinction Between Development Services and Product Purchase",
      content:
        "Clients acknowledge that IMHO's services involve custom product and process development, which differs from purchasing an off-the-shelf product or pre-existing process. Accordingly, project timelines and service charges will reflect the complexity of engineering design, procurement requirements, and fabrication or construction deliverables.",
    },
    {
      title: "Right to Reject Projects",
      content:
        "IMHO reserves the right to reject any project that is deemed illegal, unethical, or misaligned with legal, social, and moral policies within the jurisdiction in which it operates.",
    },
    {

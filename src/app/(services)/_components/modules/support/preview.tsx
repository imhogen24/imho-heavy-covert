...
// Using FieldConfig from types/form-preview.ts which now supports Date and number types
...
// Extended SectionConfig for support form with additional dateRange field
interface ExtendedSectionConfig extends SectionConfig {
  fields?: FieldConfig[];
  dateRange?: {
    label: string;
...
// Extended helper function for support form with additional types
const extendedHasSectionContent = (fields: (string | boolean | string[] | Date | number | undefined)[]) => {
...
export const FormPreview = memo(function FormPreview({ formData }: FormPreviewProps) {
  ...
  const sections: ExtendedSectionConfig[] = [
    {

...
const strictLimit = new Ratelimit({ redis, limiter: Ratelimit.fixedWindow(10, "1 m") });

const normalLimit = new Ratelimit({ redis, limiter: Ratelimit.slidingWindow(100, "1 m") });
